...
RSpec.describe 'Font' do
  ...
  describe '::ExtTextOut' do
    it 'draws text using the currently selected font, background color, and text color' do
  ...
  describe '::GetOutlineTextMetrics' do
    it 'retrieves text metrics for TrueType fonts' do
  ...
  describe '::GetTextAlign' do
    it 'retrieves the text-alignment setting for the specified device context' do
  ...
  describe '::GetTextColor' do
    it 'retrieves the current text color for the specified device context' do
      expect(GetTextColor(hdc)).not_to eq CLR_INVALID
    end
  end

  describe '::GetTextExtentExPoint' do
    it 'retrieves the number of characters in a specified string that will fit within a specified space and fills an array with the text extent for each of those characters' do
  ...
  describe '::GetTextExtentPoint' do
    it 'computes the width and height of the specified string of text' do
  ...
  describe '::PolyTextOut' do
    it 'draws several strings using the font and text colors currently selected in the specified device context' do
  ...
  describe '::SetTextAlign' do
    it 'sets the text-alignment flags for the specified device context' do
      expect(SetTextAlign(hdc, :CENTER)).not_to eq GDI_ERROR
    end
  end

  describe '::SetTextCharacterExtra' do
    it 'sets the intercharacter spacing. Intercharacter spacing is added to each character, including break characters, when the system writes a line of text' do
      expect(SetTextCharacterExtra(hdc, 0)).not_to eq 0x80000000
    end
  end

  describe '::SetTextColor' do
    it 'sets the text color for the specified device context to the specified color' do
      expect(SetTextColor(hdc, Gdi32.RGB(255, 0, 0))).not_to eq CLR_INVALID
    end
  end

  describe '::SetTextJustification' do
    it 'specifies the amount of space the system should add to the break characters in a string of text' do
      expect(SetTextJustification(hdc, 0, 0)).to be true
    end
  end

  describe '::TextOut' do
    it 'writes a character string at the specified location, using the currently selected font, background color, and text color' do
