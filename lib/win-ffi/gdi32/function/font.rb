...
require 'win-ffi/gdi32/enum/font/font/font_resource_flag'
require 'win-ffi/gdi32/enum/font/get_character_placement_flag'
require 'win-ffi/gdi32/enum/font/get_glyph_outline_format'
require 'win-ffi/gdi32/enum/font/text_align_flag'
require 'win-ffi/gdi32/enum/font/get_glyph_indices_flag'

require 'win-ffi/core/struct/size'
require 'win-ffi/gdi32/struct/font/abc'
require 'win-ffi/gdi32/struct/font/abcfloat'
require 'win-ffi/gdi32/struct/font/enum_log_font'
require 'win-ffi/gdi32/struct/font/enum_log_font_extended_design_vector'
require 'win-ffi/gdi32/struct/font/glyph_set'
require 'win-ffi/gdi32/struct/font/glyph_metrics'
require 'win-ffi/gdi32/struct/font/gcp_results'
require 'win-ffi/gdi32/struct/font/kerning_pair'
require 'win-ffi/gdi32/struct/font/log_font'
require 'win-ffi/gdi32/struct/font/mat2'
require 'win-ffi/gdi32/struct/font/outline_text_metric'
require 'win-ffi/gdi32/struct/font/poly_text'
require 'win-ffi/gdi32/struct/font/rasterizer_status'
